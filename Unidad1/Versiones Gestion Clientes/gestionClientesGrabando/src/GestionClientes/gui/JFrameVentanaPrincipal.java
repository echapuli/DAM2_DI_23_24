...
import GestionClientes.gui.tablaModels.ClientesTablaModel;
...
public class JFrameVentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemGuardar.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jMenuItemGuardarMousePressed(evt);
            }
        });
    ...
    private void inicializa(){
        JFileChooser jFileAbrir =new JFileChooser();
        int seleccion = jFileAbrir.showOpenDialog(this);
        if (seleccion == JFileChooser.APPROVE_OPTION){ //si se pulso el boton aceptar
           if (!(LogicaNegocio.cargarTabla(jFileAbrir.getSelectedFile()))) jLabelError.setText("Error al abrir el fichero");
        } 
        jTableClientes.setModel(new ClientesTablaModel(LogicaNegocio.getListaClientes()));
    }
    ...
    private void jMenuItemBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemBorrarActionPerformed
        jLabelError.setText("");
        ClientesTablaModel dtm = (ClientesTablaModel) jTableClientes.getModel();
        if (jTableClientes.getSelectedRow() == -1) {
            jLabelError.setText("Selecciona un Cliente");
        } else {
            dtm.deleteRow(jTableClientes.getSelectedRow());
        }
    ...
    private void jMenuItemGuardarMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItemGuardarMousePressed
        JFileChooser jFileAbrir =new JFileChooser();
        int seleccion = jFileAbrir.showOpenDialog(this);
        if (seleccion == JFileChooser.APPROVE_OPTION){ //si se pulso el boton aceptar
           if (!(LogicaNegocio.salvarTabla(jFileAbrir.getSelectedFile()))) jLabelError.setText("Error al salvar el fichero");
        }
    }//GEN-LAST:event_jMenuItemGuardarMousePressed

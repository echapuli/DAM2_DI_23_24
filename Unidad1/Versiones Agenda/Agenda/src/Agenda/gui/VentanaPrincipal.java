...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuBajaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuBajaMousePressed
        ...
        if (fila==-1){ //si no hay una fila seleccionada
            ...
            DefaultTableModel dtm = (DefaultTableModel)jTableAgenda.getModel(); //recuperamos su dtm
            dtm.removeRow(fila); 
        }
    ...
    private void inicializaTabla(){
        //utilizamos DefaultTableModel
        DefaultTableModel dtm=new DefaultTableModel();
        //solo meto las cabeceras
        dtm.setColumnIdentifiers(new String[]{"Nombre","Apellidos","Dirección","Teléfono"});
        //asigno el modelo de tabla a la tabla
        jTableAgenda.setModel(dtm);
    }
    public void addContacto(Contacto contacto){
        //recojo el tableModel de la tabla y le añado el cliente
        DefaultTableModel dtm=(DefaultTableModel)jTableAgenda.getModel();
        dtm.addRow(contacto.clienteArray());
    }
    /**

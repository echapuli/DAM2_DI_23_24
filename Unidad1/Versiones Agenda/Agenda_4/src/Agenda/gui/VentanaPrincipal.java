...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    public VentanaPrincipal() {
        initComponents();
        ContactosTableModel modelo = new ContactosTableModel(LogicaNegocio.getListaContactos()); //creamos el objeto pasandole al constructor la lista de contactos de la clase logicaNegocio
        jTableAgenda.setModel(modelo);
        // Instanciamos el TableRowSorter y lo añadimos al JTable
        TableRowSorter<TableModel> elQueOrdena = new TableRowSorter<>(modelo);
        jTableAgenda.setRowSorter(elQueOrdena);
    }
    ...
    private void jMenuBajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuBajaMouseClicked
        ...
        fila=jTableAgenda.convertRowIndexToModel(jTableAgenda.getSelectedRow()); //hay que convertir la fila seleccionada a su correspondiente en la lista del modelo

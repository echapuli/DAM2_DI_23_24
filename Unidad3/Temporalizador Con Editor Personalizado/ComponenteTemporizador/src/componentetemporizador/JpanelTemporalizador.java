...
public class JpanelTemporalizador extends javax.swing.JPanel implements Serializable{
    ...
    private JpanelTemporalizadorPropiedades valoresTemporalizador;
    ...
    {
        contador = valoresTemporalizador.getNumSegundos();
        Timer timer = new Timer();
        if (valoresTemporalizador.isMostrarDecimales()) //mostramos un decimal
            ...
            public void run()
            {
                if (contador>=0)
                {
                    String valorMostrar;
                     ...
                     if (valoresTemporalizador.isMostrarDecimales()){
                ...
                else
                {
                    ...
                    jLabeltemporalizador.setBackground(valoresTemporalizador.getColorFin());                    
                    jLabeltemporalizador.setText(valoresTemporalizador.getTextoFin());
                    mostrarImagen();
                }
            }
        };
    ...
    private void mostrarImagen() {
        if ((valoresTemporalizador.getImagen()!=null) && (valoresTemporalizador.getImagen().exists())){
           ImageIcon imageIcon = new ImageIcon(valoresTemporalizador.getImagen().getAbsolutePath());
    ...
    public JpanelTemporalizadorPropiedades getValoresTemporalizador() {
        return valoresTemporalizador;
    }

    public void setValoresTemporalizador(JpanelTemporalizadorPropiedades valoresTemporalizador) {
        this.valoresTemporalizador = valoresTemporalizador;
    }
